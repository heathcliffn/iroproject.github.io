...
(function(){
	...
	var Note = function(){
		...
		for(var i = 0; i < self.imgsLoadTotal; i++){
			...
			img.src = 'C:/Users/AincradHero/Desktop/IROproject/assets/images/canvas_bg/note/' + imgsLoad[i];
	...
	var NoizBg = function(){
		...
		for(var i = 0; i < this.imgsLoadTotal; i++){
			...
			//img.crossOrigin = "anonymous";
			img.onload = this.imgLoad;
			img.src = 'C:/Users/AincradHero/Desktop/IROproject/assets/images/canvas_bg/' + imgsLoad[i];
			this.loadImgs.push(img);
		}
	};
